...
public static function pdf(Router $router)
{
    ...
    $destinatario1 = "sistemas@megaecuador.com";
...
public static function pdfcompraryfinaciero(Router $router)
{
    ...
    // Enviar por correo
    $destinatario1 = "sistemas@megaecuador.com";
    $destinatario2 = "edwin.ed948@gmail.com";
    $asunto = "Aprobado para la compra de productos para el área de sistemas";
    $mensaje = "
...
public static function editarTicket(Router $router){
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($ticket->estado === "cerrado") {  // Cambiado a $ticket->estado
            $correo = new CorreoTicketU($ticket->id,'sistemas@logmegaecuador.com', $computadora->email_usuario, $ticket->computadora_id, $computadora->usuario_asignado, $ticket->estado, $ticket->prioridad);
            $correo->enviarConfirmacionTicket();
