...
class Producto extends ActiveRecord
{
    ...
    protected static $columnasDB = ['id', 'almacen', 'nombre_cliente', 'ruc_cliente','fecha_pedido','vendedor','plazo_entrega','estado_pedido','codigo_producto','nombre_producto','cantidad','pvp','subtotal','total'];
