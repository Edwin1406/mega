<h1 class="dashboard__heading"> <?= $titulo ?> </h1>
...
<ul class="lista-areas-produccion">
    ...
    <li class="areas-produccion-estatico" data-aos="fade-up">
        <a href="/admin/sistemas/ticket/tablaTicket">
        ...
        function checkStock() {
            fetch(apiUrl)
                ...
                .then(data => {
                    ...
                    const lowStockProducts = data.filter(producto => parseInt(producto.stock_actual) === 1);
