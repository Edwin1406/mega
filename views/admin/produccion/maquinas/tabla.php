            ...
            <tbody class="table__tbody">
                ...
                <?php foreach ($maquinas as $maquina):?>
                    <tr class="table__tr">
                        ...
                        <td class="table__td--acciones"><a class="table__accion table__accion--editar" href="/admin/maquinas/editar?id=<?php echo $maquina->id; ?>"><i class="fa-solid fa-user-pen"></i>Editar</a>
                        <form method="POST" action="/admin/maquinas/eliminar" class="table__formulario">
