            ...
            <tbody class="table__tbody">
                ...
                <?php foreach ($pedidosTrimar as $trimar):?>
                    <tr class="table__tr">
                        ...
                        <td class="table__td--acciones"><a class="table__accion table__accion--editar" href="/admin/produccion/cotizador/trimar?id=<?php echo $trimar->id; ?>"><i class="fa-solid fa-user-pen"></i>AGREGAR</a>
                        </td>
