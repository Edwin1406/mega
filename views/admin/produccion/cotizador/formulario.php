        ...
        while (pedidosPendientes.length > 0) {
            ...
            for (let i = 0; i < pedidosPendientes.length; i++) {
                ...
                for (let j = i + 1; j < pedidosPendientes.length; j++) {
                    ...
                    // Si la suma de ambos pedidos más el refile es menor o igual al ancho de la bobina
                    let totalPedido = pedidoActual + siguientePedido + 30; // 30 mm de refile
                    if (totalPedido <= bobina) {
