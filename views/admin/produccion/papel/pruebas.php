...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario_campito">
        <div class="formulario__campo">
            <label class="formulario__label" for="dato">dato</label>
            <input
                type="number"
                name="dato"
                id="dato"
                ...
                placeholder="dato"
                value="<?php echo $papel->dato ?? '' ?>">
        </div>

        <div class="formulario__campo">
            <label class="formulario__label" for="dato1">dato1</label>
            <input
                type="number"
                name="dato1"
                id="dato1"
